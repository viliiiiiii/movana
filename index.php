...
<head>
  ...
  <title>Movana | Modern Web App Development</title>
...
<body class="antialiased">
    ...
    <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center">
      <div class="md:w-1/2 mb-12 md:mb-0 animate-on-scroll">
        <h1 class="text-4xl md:text-5xl font-bold leading-tight mb-6">
          Build your perfect web application
        </h1>
        <p class="text-xl text-gray-600 mb-8 max-w-lg">
          We design and develop custom web applications tailored to your business needs with modern technologies and clean code.
        </p>
        <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          <a href="#contact" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 transition-colors">
            Start Your Project
          </a>
  ...
  <div class="py-12 bg-gray-50">
    <div class="max-w-7xl mx-auto px-6">
      <p class="text-center text-sm font-medium uppercase text-gray-500 tracking-wider mb-8">
        Trusted by innovative companies
      </p>
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div class="flex justify-center opacity-60 hover:opacity-100 transition-opacity">
          <img class="h-8" src="https://logo.clearbit.com/stripe.com" alt="Stripe">
        </div>
        <div class="flex justify-center opacity-60 hover:opacity-100 transition-opacity">
          <img class="h-8" src="https://logo.clearbit.com/shopify.com" alt="Shopify">
        </div>
        <div class="flex justify-center opacity-60 hover:opacity-100 transition-opacity">
          <img class="h-8" src="https://logo.clearbit.com/airbnb.com" alt="Airbnb">
        </div>
        <div class="flex justify-center opacity-60 hover:opacity-100 transition-opacity">
          <img class="h-8" src="https://logo.clearbit.com/slack.com" alt="Slack">
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="py-20 bg-white">
    <div class="max-w-4xl mx-auto px-6">
      <div class="bg-gray-50 p-8 md:p-12 rounded-xl border border-gray-200 animate-on-scroll">
        <div class="flex items-center mb-6">
          <div class="flex -space-x-1">
            <img class="w-12 h-12 rounded-full border-2 border-white" src="https://randomuser.me/api/portraits/women/32.jpg" alt="">
          </div>
          <div class="ml-4">
